                ...
                <Card className="overflow-hidden border-0 shadow-floating hover:shadow-travel transition-all duration-500 bg-card/90 backdrop-blur-sm h-full">
                  ...
                  <CardContent className="p-6">
                    ...
                    <Button 
                      variant="travel" 
                      className="w-full"
                      onClick={() => window.open(`https://wa.me/1234567890?text=I'm interested in the ${program.title} educational tour`, '_blank')}
                    >
                      Request Information
                    </Button>
                  </CardContent>
          ...
          >
            ...
            >
              <Button
                variant="secondary"
                size="lg"
                onClick={() => window.open('https://wa.me/1234567890?text=I\'d like to discuss educational tour options for my school', '_blank')}
                className="group"
              >
