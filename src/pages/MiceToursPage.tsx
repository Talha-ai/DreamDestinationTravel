                ...
                <Card className="h-full border-0 shadow-floating hover:shadow-travel transition-all duration-500 bg-card/90 backdrop-blur-sm">
                  ...
                  <CardContent className="p-6">
                    ...
                    <Button 
                      variant="travel" 
                      className="w-full"
                      onClick={() => window.open(`https://wa.me/7683931222?text=I'm interested in the ${pkg.title} MICE package`, '_blank')}
                    >
                      Get Quote
                    </Button>
                  </CardContent>
          ...
          >
            ...
            >
              <Button
                variant="secondary"
                size="lg"
                onClick={() => window.open('https://wa.me/7683931222?text=I\'d like to discuss MICE services for my company', '_blank')}
                className="group"
              >
