                ...
                <Card className="overflow-hidden border-0 shadow-floating hover:shadow-travel transition-all duration-500 bg-card/90 backdrop-blur-sm h-full">
                  ...
                  <CardContent className="p-6">
                    ...
                    <Button 
                      variant="travel" 
                      className="w-full"
                      onClick={() => window.open(`https://wa.me/7683931222?text=I'm interested in the ${destination.title} package`, '_blank')}
                    >
                      Learn More
                    </Button>
                  </CardContent>
          ...
          >
            ...
            >
              <Button
                variant="secondary"
                size="lg"
                onClick={() => window.open('https://wa.me/7683931222?text=I\'d like to explore domestic tour options', '_blank')}
                className="group"
              >
